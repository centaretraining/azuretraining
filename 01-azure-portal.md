...
5. Click "Review + Create" to move on to the review page. This pagew lists all changes that will be made. Click "Create". You should see your resource group in the list after a few seconds.
